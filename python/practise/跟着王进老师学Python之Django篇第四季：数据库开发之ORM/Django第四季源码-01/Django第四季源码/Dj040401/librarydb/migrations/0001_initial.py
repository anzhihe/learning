    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bookauthor', models.ForeignKey(db_column='BookAuthorID', on_delete=django.db.models.deletion.DO_NOTHING, to='librarydb.Author')),
            ],
            options={
                'db_table': 'Book',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bookid', models.ForeignKey(db_column='BookId', on_delete=django.db.models.deletion.DO_NOTHING, to='librarydb.Book')),
            ],
            options={
                'db_table': 'BorrowBook',
                'managed': True,
        ...
        migrations.AddField(
            ...
            name='sno',
            field=models.ForeignKey(db_column='SNO', on_delete=django.db.models.deletion.DO_NOTHING, to='librarydb.Student'),
        ),
        migrations.AddField(
            model_name='book',
            name='bookpress',
            field=models.ForeignKey(db_column='BookPressID', on_delete=django.db.models.deletion.DO_NOTHING, to='librarydb.Press'),
        ),
        migrations.AddField(
            model_name='book',
            name='booktype',
            field=models.ForeignKey(db_column='BookTypeID', on_delete=django.db.models.deletion.DO_NOTHING, to='librarydb.Booktype'),
        ),
    ]
